-- Safe migration script to update announcements table schema
-- Run this in your Supabase SQL editor
-- This version checks for existing tables and handles them safely

-- First, let's check what exists and handle it safely
...
-- Create trigger for announcement_comments updated_at
DO $$
BEGIN
    IF EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'set_updated_at') THEN
...
-- Success message
SELECT 'Announcements schema updated successfully!' as result;